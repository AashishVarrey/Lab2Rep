...
#variables and constants for pwm objects
f = 1
dc = 50
pwm1 = GPIO.PWM(led1,f)
pwm2 = GPIO.PWM(led2,f)

#threaded callback function, two for loops, one for brightness one for dimming
...
#main code, execute callbacks based on which button pushed
try:
    pwm = GPIO.PWM(led3,f)
    pwm.start(dc)
